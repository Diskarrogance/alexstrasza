...
class ControllerFactory
{
     ...
     * @return Controller
     */
    public function getController($controller, $version = 'v_1_0_1')
    {
        ...
        $class_name = "app\\Controllers\\$version\\$controller_new";
        if (class_exists($class_name)) {
            ...
            $class_name = "Server\\Controllers\\$version\\$controller_new";
            if (class_exists($class_name)) {
                $controller_instance = new $class_name;
                $controller_instance->core_name = $controller;
                $this->addNewCount($controller);
